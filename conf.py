...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS Tutorials} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{30pt}{\baselineskip}\selectfont \textbf{Tutorials}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'EnOS Tutorials',
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'EnOS Tutorials',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Tutorials',
