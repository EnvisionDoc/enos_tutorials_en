...
3. Click edit_tem| Edit the new device template;
...
2. View the historical data.
   ...
   Click the |module3_search_button| icon of the data record to view historical data of the current model point.
...
.. |edit_tem| image:: media/module3_edit_new_device_template.png

.. |module3_search_button| image:: media/module3_search_button.png
